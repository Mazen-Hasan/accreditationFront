...
class TemplateFieldController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            return datatables()->of($data)
                ->addColumn('action', function ($data) {
                    $button = '';
                    if ($data->can_edit == 1) {
                            $button = '<a href="javascript:void(0)" data-toggle="tooltip" id="edit-field"  data-id="' . $data->field_id . '" data-original-title="Edit" title="Edit"><i class="fas fa-edit"></i></a>';
                            $button .= '&nbsp;&nbsp;';
                            $button .= '<a href="javascript:void(0)" data-toggle="tooltip" id="delete-field"  data-id="' . $data->field_id . '" data-original-title="Delete" title="Delete"><i class="far fa-trash-alt"></i></a>';
                            $button .= '&nbsp;&nbsp;';
                    }

                    if ($data->details == 1) {
                        $button .= '<a href="' . route('templateFieldElements', $data->field_id) . '" data-toggle="tooltip" data-original-title="Delete" data-id="' . $data->field_id . '" title="Elements"><i class="far fa-list-alt"></i></a>';
                    }
                    return $button;
                })
                ->rawColumns(['action'])
    ...
    public function store(Request $request)
    {
        ...
        $body = [
            ...
            "order" => isset( $request->field_order ) ? $request->field_order : "0",
